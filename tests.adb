...
procedure Tests is
   ...
   -- Single element arrays must use named notation in Ada
   Data_Single_F : constant Dataset := ((1 => 1.0), (1 => 2.0), (1 => 3.0), (1 => 4.0));
...
begin
   ...
   declare
      Data_Contradict : constant Dataset := ((1 => 1.0), (1 => 1.0));
